 ...
 */
factoryParameterSettingApp.controller('sparePartsManageController',function ($scope,UrlService,$http,$filter,$cookies,$resource, $location, $state, factoryParameterSettingService) {
