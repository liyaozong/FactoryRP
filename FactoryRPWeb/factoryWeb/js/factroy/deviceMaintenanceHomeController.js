 ...
 */
factoryParameterSettingApp.controller('deviceMaintenanceHomeController',function ($scope,UrlService,$http,$filter,$cookies,$resource, $location, $state, factoryParameterSettingService,departmentManageService) {
    ...
    $scope.queryMaintenanceRecordList=function(){
        $scope.queryMaintenanceRecordListss = factoryParameterSettingService.queryMaintenanceRecordAllLists({
...
//                        $scope.useDeptEdit=$(this).val();
    ...
    $scope.chooseDevice=function(){
        popupDiv('deviceLists');
        $scope.deviceListsRecordSure=function(){
...
//                                $scope.useDeptMaintenance=$(this).val().split(':')[1];
    ...
    $scope.hideDeviceLists=function(){
        hideDiv('deviceLists');
        $("#bg1").show();
    };
    /*选择设备 end*/
    ...
    $scope.editMaintenanceRecord=function (res) {
        factoryParameterSettingService.queryMaintenanceRecordById({
            ...
            if(response.data!=''&&response.data!=null&&response.data!=undefined&&response.errorCode=='000000'){
                ...
                $scope.deviceId=$scope.oneMaintenanceType.deviceId;//设备ID
